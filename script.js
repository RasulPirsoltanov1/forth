    ...
    fetch('https://jsonplaceholder.typicode.com/todos')
        ...
        .then(json => {
            ...
            for (let i = 0; i < json.length; i++) {
                ...
                card.innerHTML += `<div class="card col-md-3 shadow-lg p-3 mb-5 bg-body rounded" style="width: 18rem; margin:20px; "><div class="card-body" > <h5 class="card-title"> title: ${json[i].title}</h5>
